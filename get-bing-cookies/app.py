...
with gr.Blocks() as iface:
    ...
    url_input = gr.Textbox(label="验证服务器url",value="https://dongsiqie-go-bingai-pass.hf.space")
    ...
    gr.Markdown("使用方法：在go-proxy-bingai项目中，点击右上角的齿轮，点【设置】，点击【完整 Cookie】，然后将验证后的cookies的cookies填写到【Cookies】中")
